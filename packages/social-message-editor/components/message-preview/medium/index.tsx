...
export const MediumPreview = ( {
	...
	return (
		<div className="nelio-content-social-message-medium-preview">
			<div className="nelio-content-social-message-medium-preview__content">
				<div className="nelio-content-social-message-medium-preview__title">
					{ post?.title }
				</div>
				<div className="nelio-content-social-message-medium-preview__profile-and-name">
					<SocialProfileIcon
						profileId={ profileId }
						isNetworkHidden={ true }
					/>

					<div className="nelio-content-social-message-medium-preview__display-name-and-date">
						<div className="nelio-content-social-message-medium-preview__display-name">
							{ displayName }
						</div>
						<div className="nelio-content-social-message-medium-preview__date">
							{ dateI18n(
								_x(
									'F j, Y',
				...
				<div className="nelio-content-social-message-medium-preview__medium-toolbar">
					<div className="nelio-content-social-message-medium-preview__medium-toolbar-section">
						<svg
