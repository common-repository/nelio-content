...
type DateType = Exclude< EditorialTask[ 'dateType' ], 'predefined-offset' >;
...
export const DefaultSelector = ( {
	...
	<SelectControl
		className="nelio-content-task-editor-date-due__default-select"
		disabled={ disabled }
		options={ OPTIONS }
		value={ dateValue }
...
const isDateType = ( x: Option[ 'value' ] ): x is DateType =>
	[ 'positive-days', 'negative-days', 'exact' ].includes( x );
